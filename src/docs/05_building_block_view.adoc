...
image:Contexto-del-sistema.png["Arquitectura del Contexto del Sistema"]
...
El propósito de esta caja negra es representar a un usuario y a su POD, junto con sus datos. 

La interfaz de esta caja se resume basicamente a las operaciones de lectura y escritura en los PODs que se llevará a cabo mediante librerías que se ajustan a la especificación SOLID. 
