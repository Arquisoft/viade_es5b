...
App -> BBDD: Guarda la ruta en los PODs de los amigos seleccionados.
BBDD -> AppAmigo: Obtiene la ruta compartida.
AppAmigo -> Usuario: Notifica que le han compartido una ruta.
