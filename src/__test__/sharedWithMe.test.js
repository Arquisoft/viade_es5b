...
let ruta2 = new Ruta("Ruta Oviedo", [7.5, 8.4], "Muy buena ruta, entretenida.");
let hito3 = new Hito("Uria", 7.0, 7.5);
let hito4 = new Hito("Catedral", 8.0, 8.3);
ruta.addHito(hito3);
ruta.addHito(hito4);
...
test("Se renderizan bien los componentes de SharePanel", () => {
    afterAll(cleanup);
    const { getByTestId } = render(<SharedWithMe state={rutas}></SharedWithMe>);
